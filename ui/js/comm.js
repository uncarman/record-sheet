...
var settings = {
    ...
    ajax_func: {
        getTypes: "getTypes", // 目前不用, hardcode 结果
        getPoints: "/api/locations",
        getPoint: "/api/locations",
        getRecords: "/api/maintain_logs",
    ...
    types: {
        ...
        "故障报修": {
            ...
            "color": "#86B4C3",
            "style": {'background-color': '#86B4C3'}
        },
    },

    default_img : "imgs/c3bc39d3dcc324f7e276acca7f71ac29.png",
...
var global = {
    ...
    generateAuthorization: function(param) {
        var str = settings.username + ":" + settings.password;
        return btoa(str);
    },
    ...
    ajax_data: function($scope, params, success_func, error_func, success_code) {
        ...
        global.ajax($scope, params, function(data){
            ...
            try {
                data.curPage = data.meta.current_page;
                data.totalPage = data.meta.last_page;
            } catch(e) {
                // pass
            }
            try{
